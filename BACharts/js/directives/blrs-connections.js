            ...
            return {
                ...
                link: function(scope, iElement, iAttrs) {
                    ...
                    scope.render = function(data, settings){
                        ...
                        var maxScore = d3.max(data.values, function(d){ return d.score});
                        var maxActivities = d3.max(data.values, function(d){ return d.activities});
                       ...
                       var median = svg.append("line")
                        ...
                        svg.append("text")
                            ...
                            .attr("y", function(d){return height - this.getBBox().height/2 })
                        ...
                        svg.append("text")
                            ...
                            .attr("x", -height/2)
                            .attr("y", function(d){ return this.getBBox().height })
                            .style("text-anchor", "middle");
                        ...
                        var dots = svg.append("g").selectAll("circle")
                            ...
                            .attr("cy", function(d){return yScale(d.activities)})
                            .attr("r", dotSize/2)
                            .attr("opacity", 0);

                        dots.transition().ease(ease)
                            .delay(function(d){return Math.random() * duration})
                            .attr("opacity", 1);
